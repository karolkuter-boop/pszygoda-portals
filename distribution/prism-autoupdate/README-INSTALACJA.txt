PSZYGODA PORTALS - INSTANCJA PRISM Z AUTOMATYCZNA AKTUALIZACJA R4

1. Otworz Prism Launcher.
2. Kliknij Dodaj instancje -> Importuj.
3. Wskaz ten plik ZIP.
4. Upewnij sie, ze powstala instancja o nazwie Pszygoda Portals AutoUpdate R5.
...
AutoUpdate R5 i uruchamia plik packwiz-update.cmd zamiast pustego $INST_JAVA.
